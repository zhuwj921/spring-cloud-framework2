...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/service-component/service-user//src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/service-component/service-user/src/main/resources/mapper/" + pc.getModuleName()
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.cloud.common.base.BaseController");
